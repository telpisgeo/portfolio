          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="lg:sticky lg:top-24 lg:self-start">
              ...
              <div className="flex flex-col gap-5 text-lg text-foreground/75 leading-relaxed">
                {locale === "uk" ? (
                  <>
                    <p>Привіт, я Георгій — продуктовий дизайнер з досвідом понад 8 років у проєктуванні цифрових SaaS-продуктів.</p>
                    <p>Спеціалізуюсь на EdTech та MarTech. Проходжу повний дизайн-цикл: від user research і IA до Figma-специфікацій і handoff розробникам. Найкраще працюю коли я перший дизайнер у команді — будую процеси з нуля.</p>
                    <p>Маю досвід у інструментах email-маркетингу, автоматизації LinkedIn outreach, конструкторах курсів та освітніх мобільних додатках.</p>
                    <p>Захоплююсь AI-прототипуванням та vibe coding — люблю коли ідея за кілька днів стає реальним продуктом, який можна протестувати на користувачах.</p>
                  </>
                ) : (
                  <>
