              ...
              <div className="flex flex-col gap-5 text-lg text-foreground/75 leading-relaxed">
                {locale === "uk" ? (
                  <>
                    ...
                    <p>Спеціалізуюсь на EdTech та MarTech. Проходжу повний дизайн-цикл: від досліджень і архітектури інформації до специфікацій у Figma і передачі розробникам. Найкраще працюю коли я перший дизайнер у команді — будую процеси з нуля.</p>
