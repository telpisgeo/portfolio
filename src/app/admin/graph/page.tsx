...
import type { HomeCompany, HomeImageRow, Testimonial, TimelineItem } from "@/lib/home-content";
    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="flex items-center justify-between mb-10">
          <h1 className="text-2xl font-medium text-foreground">Сторінка для граф дизайну</h1>
        ...
        <p className="text-sm text-muted-foreground mb-10">
          Незалежна версія сайту для граф дизайну: {" "}
          <a href={`/graph/${locale === "uk" ? "ua" : "en"}`} target="_blank" rel="noopener noreferrer" className="underline underline-offset-2 hover:text-foreground">
            /graph/{locale === "uk" ? "ua" : "en"}
          </a>
          . Контент нижче не впливає на головну сторінку.
        </p>
        ...
        {/* CV link */}
        <div className="border border-border rounded-2xl p-6 mb-10">
          <h2 className="text-base font-medium text-foreground mb-5">Посилання на CV</h2>
          <div>
