...
export default function Footer({ locale, copyright }: FooterProps) {
  ...
  const blurb = isUk
    ? "Я люблю читати книги про дизайн, можу просто гортати арт-книги для візуального задоволення, читати тредс колег — а ще ваші листи, якщо ви, звісно, дочитали до цього моменту."
    : "I love reading design books, flipping through art books just for the visual pleasure, reading colleagues' threads — and your emails too, if you've actually read this far.";

  return (
    <footer className="bg-[#141210] text-[#f0ead8]">
      {/* light cap: page bg curves down into the dark footer (dark fills the corners) */}
      <div className="bg-[#fdf8e7] h-10 rounded-b-[40px]" aria-hidden />
      <div className="max-w-[1440px] w-full mx-auto px-6 sm:px-12 pt-20 pb-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Left: contact + blurb + socials */}
          <div className="flex flex-col">
            <a
              href="mailto:gtelpis@gmail.com"
              className="text-[clamp(1.6rem,6vw,3.25rem)] font-medium leading-none hover:opacity-80 transition-opacity break-all w-fit"
            >
              gtelpis@gmail.com
            </a>

            <p className="mt-7 text-base text-[#f0ead8]/65 leading-relaxed max-w-[540px]">
              {blurb}
            </p>
            ...
            <div className="mt-8 flex items-center gap-5">
              <a
                ...
                aria-label="LinkedIn"
                className="text-[#f0ead8]/70 hover:text-[#f0ead8] transition-colors"
              >
              ...
              <a
                href="https://www.instagram.com/gtelpis/"
                target="_blank"
                rel="noopener noreferrer"
            ...
            <p className="mt-10 text-xs text-[#f0ead8]/45">{copyright}</p>
          </div>
